...
void UpdateScore(void)
{
	...
	for (nCntScore = 0; nCntScore < MAX_SCORE_POLYGON; nCntScore++)
	{
		...
		if (nCntScore == 0)
		{
			pVtx[0].tex = D3DXVECTOR2(g_Score / (int)powf(10, MAX_SCORE_POLYGON - 1)*0.1f, 0.0f);
			pVtx[1].tex = D3DXVECTOR2(g_Score / (int)powf(10, MAX_SCORE_POLYGON - 1)*0.1f + 0.1f, 0.0f);
			pVtx[2].tex = D3DXVECTOR2(g_Score / (int)powf(10, MAX_SCORE_POLYGON - 1)*0.1f, 1.0f);
			pVtx[3].tex = D3DXVECTOR2(g_Score / (int)powf(10, MAX_SCORE_POLYGON - 1)*0.1f + 0.1f, 1.0f);
		}
		else if (nCntScore == MAX_SCORE_POLYGON - 1)
		{
		...
		{
			pVtx[0].tex = D3DXVECTOR2(g_Score % (int)powf(10, MAX_SCORE_POLYGON - nCntScore) / (int)powf(10, MAX_SCORE_POLYGON - 1 - nCntScore) *0.1f, 0.0f);
			pVtx[1].tex = D3DXVECTOR2(g_Score % (int)powf(10, MAX_SCORE_POLYGON - nCntScore) / (int)powf(10, MAX_SCORE_POLYGON - 1 - nCntScore)*0.1f + 0.1f, 0.0f);
			pVtx[2].tex = D3DXVECTOR2(g_Score % (int)powf(10, MAX_SCORE_POLYGON - nCntScore) / (int)powf(10, MAX_SCORE_POLYGON - 1 - nCntScore)*0.1f, 1.0f);
			pVtx[3].tex = D3DXVECTOR2(g_Score % (int)powf(10, MAX_SCORE_POLYGON - nCntScore) / (int)powf(10, MAX_SCORE_POLYGON - 1 - nCntScore)*0.1f + 0.1f, 1.0f);
		}
