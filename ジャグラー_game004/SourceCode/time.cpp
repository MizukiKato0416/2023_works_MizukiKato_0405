...
void InitTime(void)
{
	...
	{
		g_aTimePolygon[nCntTime].pos = D3DXVECTOR3(TIME_POLYGON_WIDTH / 2.0f + (TIME_POLYGON_WIDTH * nCntTime) , 0.0f, 0.0f);
	}
	g_nTime = 120;
	g_nCntTime = 0;
	...
	{
		//頂点座標
		pVtx[0].pos = D3DXVECTOR3(g_aTimePolygon[nCntTime].pos.x - TIME_POLYGON_WIDTH / 2.0f, g_aTimePolygon[nCntTime].pos.y, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(g_aTimePolygon[nCntTime].pos.x + TIME_POLYGON_WIDTH / 2.0f, g_aTimePolygon[nCntTime].pos.y, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(g_aTimePolygon[nCntTime].pos.x - TIME_POLYGON_WIDTH / 2.0f, g_aTimePolygon[nCntTime].pos.y + TIME_POLYGON_HEIGHT, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(g_aTimePolygon[nCntTime].pos.x + TIME_POLYGON_WIDTH / 2.0f, g_aTimePolygon[nCntTime].pos.y + TIME_POLYGON_HEIGHT, 0.0f);
