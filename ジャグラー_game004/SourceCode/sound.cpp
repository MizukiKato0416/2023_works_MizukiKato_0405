...
//=================================
	...
	{ "data/BGM/Game.wav", -1 },			// ゲームのBGM
	{ "data/BGM/Fever.wav", -1 },			// フィーバーの時のBGM
	{"data/BGM/Result.wav", -1},			// ランキングのBGM
//=================================
//SE
//=================================
	{ "data/SE/drumRoll.wav", 0 },			//タイトル名が出てくる時のSE
	{ "data/SE/enter.wav", 0 },			//エンターを押したときのSE
	{ "data/SE/Fever.wav", 0 },			//フィーバーの時のSE
	{ "data/SE/roll.wav", 0 },				//スペース押したときSE
	{ "data/SE/space.wav", 0 },			//スペース押したときSE←この二つは同時にs
	{ "data/SE/title.wav", 0 },
	{ "data/SE/SCORE.wav", 0 }
};
