...
{
	D3DXVECTOR3 posAsk[MAX_ENEMY_FAT_MODEL];		//求めたい値
	D3DXVECTOR3 rotAsk[MAX_ENEMY_FAT_MODEL];		//求めたい値
	D3DXVECTOR3 posDiffer[MAX_ENEMY_FAT_MODEL];	//差分
	D3DXVECTOR3 rotDiffer[MAX_ENEMY_FAT_MODEL];	//差分
