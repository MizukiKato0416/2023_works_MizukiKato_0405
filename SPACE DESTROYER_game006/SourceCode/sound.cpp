...
{
	{ "data/SE/bullet000.wav", 0 },				//弾発射SE
	{ "data/SE/explosion000.wav", 0 },			//爆発SE
	{ "data/SE/title_start_se.wav", 0 },		//タイトルのスタートボタンSE
	{ "data/SE/cursor_se.wav", 0 },				//カーソル移動SE
	{ "data/SE/decide_se_00.wav", 0 },			//決定SE00
	{ "data/SE/exit_se.wav", 0 },				//戻るSE
	{ "data/SE/exit_tutorial_se.wav", 0 },		//チュートリアルの戻るSE
	{ "data/SE/pause_open_se.wav", 0 },			//ポーズSE
	{ "data/SE/next_page_se.wav", 0 },			//次の説明ページSE
	{ "data/SE/boss_bullet_se.wav", 0 },		//ボスの弾SE
	{ "data/SE/boss_laser_se.wav", 0 },			//ボスのレーザーSE
	{ "data/SE/die_explosion_se.wav", 0 },		//ボスとプレイヤーが死んだSE
	{ "data/SE/game_clear_se.wav", 0 },			//ゲームクリアSE
	{ "data/SE/item_power_se.wav", 0 },			//パワーアイテムSE
	{ "data/SE/item_speed_se.wav", 0 },			//スピードアイテムSE
	{ "data/BGM/title_bgm.wav", -1 },			//タイトルBGM
	{ "data/BGM/menu_bgm.wav", -1 },			//メニューBGM
	{ "data/BGM/game01_bgm.wav", -1 },			//ゲーム01BGM
	{ "data/BGM/boss_bgm.wav", -1 },			//ボス登場時BGM
