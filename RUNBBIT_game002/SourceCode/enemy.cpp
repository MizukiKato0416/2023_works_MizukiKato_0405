...
void UpdateEnemy(void)
{
	...
	for (nCntEnemy = 0; nCntEnemy < MAX_ENEMY; nCntEnemy++)
	{
		...
		if (g_aEnemy[nCntEnemy].bUse == true)
		{
			...
			if (g_aEnemy[nCntEnemy].pos.x - g_aEnemy[nCntEnemy].fEnemyWidth / 2.0f <= SCREEN_WIDTH)
			{
			...
			if (g_aEnemy[nCntEnemy].move.x != 0.0f)
			{
				...
				if (g_aEnemy[nCntEnemy].nCounterAnim++ >= 40)
				{
					...
					if (g_aEnemy[nCntEnemy].move.x < 0.0f)
					{
						...
						pVtx[2].tex = D3DXVECTOR2(0.0f + 0.5f * g_aEnemy[nCntEnemy].nPatternAnim, 0.5f);
						pVtx[3].tex = D3DXVECTOR2(0.5f + 0.5f * g_aEnemy[nCntEnemy].nPatternAnim, 0.5f);
					}
					else if (g_aEnemy[nCntEnemy].move.x > 0.0f)
					{
						pVtx[0].tex = D3DXVECTOR2(0.0f + 0.5f * g_aEnemy[nCntEnemy].nPatternAnim, 0.5f);
						pVtx[1].tex = D3DXVECTOR2(0.5f + 0.5f * g_aEnemy[nCntEnemy].nPatternAnim, 0.5f);
				...
				if (g_aEnemy[nCntEnemy].pos.x + g_aEnemy[nCntEnemy].fEnemyWidth / 2.0f <= 0.0f)
				{
					g_aEnemy[nCntEnemy].bUse = false;
				}
