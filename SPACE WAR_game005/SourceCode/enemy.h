...
#define ENEMY_SEARCH (1000.0f)							//プレイヤーを探し出す範囲
...
#define MAX_ENEMY_MODEL (10)							//モデルの最大数
...
#define ENEMY_NOMAL_R (80.0f)							//敵ノーマルの当たり判定の半径
#define ENEMY_NOMAL_B (150.0f)							//敵ボスの当たり判定の半径
...
typedef enum
{
	...
	ENEMY_MOTIONTYPE_DAMAGE,			//被弾モーション
