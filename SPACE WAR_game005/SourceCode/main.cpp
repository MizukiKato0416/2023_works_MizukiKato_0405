...
#define WINDOWS_NAME "SPACE WAR"					//ウィンドウの名前(キャプション名)
...
void DrawCameratxt(void)
{
	...
	int nNum = sprintf(&strtage[0], "視点X:%f\nY:%f\nZ:%f\n", pCamera->posV.x, pCamera->posV.y,pCamera->posV.z);
	nNum += sprintf(&strtage[nNum], "注視点X:%f\nY:%f\nZ:%f\n", pCamera->posR.x, pCamera->posR.y, pCamera->posR.z);
	nNum += sprintf(&strtage[nNum], "player.rot.y:%f\n", pPlayer->rot.y);
	nNum += sprintf(&strtage[nNum], "player.pos.X:%f\nY:%f\nZ:%f\n", pPlayer->pos.x, pPlayer->pos.y, pPlayer->pos.z);
	nNum += sprintf(&strtage[nNum], "player.move.X:%f\nY:%f\nZ:%f\n", pPlayer->move.x, pPlayer->move.y, pPlayer->move.z);
	nNum += sprintf(&strtage[nNum], "camera.rot.y:%f\n", pCamera->rot.y);
